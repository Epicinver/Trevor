...
object CallbackData {
    ...
    const val salaryToday = "#salaryToday"
    const val salaryList = "#salaryList"
    const val addToSalaryList = "#addToSalaryList"
    const val notAddToSalaryList = "#notAddToSalaryList"
    const val goingToGetPaid = "#goingToGetPaid"
